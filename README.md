...
<td>
  <strong>Looking for the implementation?</strong> <a href="https://github.com/braincol/braincol-vault"><strong>Braincol Vault</strong></a> is the first open-source implementation of the NL Protocol — a local-first secret manager with MCP server, so your AI agents can use secrets without ever seeing them.
</td>
</tr>
</table>
...
| [**Braincol Vault**](https://github.com/braincol/braincol-vault) | Standard (L1-L5) | Python | Local-first secret manager with MCP server, 7 AI agent integrations. |
